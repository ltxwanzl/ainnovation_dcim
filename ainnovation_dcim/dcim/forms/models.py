...
class RackReservationForm(BootstrapMixin, TenancyForm, CustomFieldModelForm):
    ...
    class Meta:
        ...
        fieldsets = (
            ('预占', ('region', 'site', 'location', 'rack', 'units', 'user', 'description', 'tags')),
            ('租户', ('tenant_group', 'tenant')),
        )
...
class PowerPanelForm(BootstrapMixin, CustomFieldModelForm):
    ...
    class Meta:
        ...
        fieldsets = (
            ('电源面板', ('region', 'site_group', 'site', 'location', 'name', 'tags')),
        )
...
class PowerFeedForm(BootstrapMixin, CustomFieldModelForm):
    ...
    class Meta:
        ...
        fieldsets = (
            ('电源面板', ('region', 'site', 'power_panel')),
            ('供电', ('rack', 'name', 'status', 'type', 'mark_connected', 'tags')),
